...
subtitle: "Data collected for my Career Development SA Position"
author: "Sofia Sarak"
date: April 11, 2026
format: html
editor: visual
...
Alongside being a full-time Master's student, I also work part-time as the Student Assistant for the [Bren School's Career Development Team](https://bren.ucsb.edu/career-services). In this role, I primarily search for open environmental data science (EDS) positions to repost on the Bren School's networking platform (kind of like an internal LinkedIn). I find it interesting to see what kind of positions my degree prepares me for, it helps me in my own job search, too. I also find it incredibly rewarding to help out my classmates (hopefully making their job search easier) and work with my supervisor, Miya.

In addition to the job posts, I collect data on the roles I find. I compile and analyze all of my observations in a quarterly report. I completed one for the fall, and am now on the winter rendition. In this blog post, I include two formats of my EDS job market review: an infographic and a written summary. I was inspired to make the infographic after taking Data Communication & Visualization in the winter quarter and having to [make my own](https://sofiasarak.github.io/blog/ukrainian-sunflowers-infographic/) for the final project. I compiled information in a written summary because it is a more useful format for the career and curriculum teams at Bren.

Both forms of the report are included in this blog post -- I will let them speak for themselves, rather than being redundant in the intro. Each section also features my own personal reflection on the output and my process, which was not included in the final product I handed over to the supervisor. Enjoy!
...
I'm really proud of how this infographic came out. I used Affinity to compile the plots (which I made in R) and add descriptive text. Some changes I made to the plots themselves include adjusting the size of the text labels in the "Environmental Field" bubble chart and "Hard Skill Specifications" tree map, as well as re-positioning bar chart labels so they sit either above or within the bar itself. (Spoiler alert: I figure out how to do this completely in R later on!).

I particularly happy with how the bubble chart and treemap came out, since this was my first time attempting those visualizations forms. I also like my color palette: the blue and green I matched to that of the [Bren logo](https://bren.ucsb.edu/about/origins-bren-logo), but I thought that the lavender was a nice accent color.

Something I would have continued working on if I had had the time was the salary box plot: I wanted to think more critically about whether or not I should include the outliers, since they do go quite far off the chart (specifically in the top right corner). I also wonder if the map of the United States is the most effective way of conveying geographic distribution information, since that data is so skewed towards California and New York. Finally, some of the spacing between text and plots could use some honing.
...
## Environmental Data Science Job Market, October through March
...
## Comparing the Fall Job Market to Winter's
