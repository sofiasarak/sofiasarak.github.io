...
#| echo: false
# Loading in data
biota <- read_csv(here("blog/montana-trace-elements-models/data/biota.csv")) %>% 
  clean_names()
sediment <- read_csv(here("blog/montana-trace-elements-models/data/sediment.csv")) %>% 
  clean_names()
waterquality <- read_csv(here("blog/montana-trace-elements-models/data/waterquality.csv")) %>% 
  clean_names()
```
